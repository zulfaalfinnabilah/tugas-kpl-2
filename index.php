            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Sign up skuy!</h2>
                        <form action="daftar.php" method= "post" target="notis" class="login-form">
                            ...
                            <label for="inputLevel" required="" class="form-label">Level</label>
              <select id="inputLevel" name="level" class="form-select">
              <div class="form-group">
              <option>1</option>
              <option>2</option>
              </select>
